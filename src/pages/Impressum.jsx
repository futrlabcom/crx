...
export default function Impressum() {
  return (
    <LegalPage title="Impressum">
      ...
      <h2>Hinweis</h2>
      <p>
        Diese Website wird im Auftrag der <strong>CRX Management GmbH</strong> betrieben.
      </p>
      <p>
        Die <strong>CRX Real Estate GmbH</strong>, eingetragen im Handelsregister des Amtsgerichts Charlottenburg unter HRB 264305, fungiert als Muttergesellschaft.
      </p>
